...
def low(image_path):
    ...
    if 'inverted' in image_path:
        path_to_low_thresh = 'resources/test2/threshold_low_inverted.jpg'
        cv2.imwrite(path_to_low_thresh, low)
        return path_to_low_thresh
    path_to_low_thresh = 'resources/test2/threshold_low.jpg'
    cv2.imwrite(path_to_low_thresh, low)
    return path_to_low_thresh
...
def mid(image_path):
    ...
    if 'inverted' in image_path:
        path_to_mid_thresh = 'resources/test2/threshold_mid_inverted.jpg'
        cv2.imwrite(path_to_mid_thresh, mid)
        return path_to_mid_thresh
    path_to_mid_thresh = 'resources/test2/threshold_mid.jpg'
    cv2.imwrite(path_to_mid_thresh, mid)
    return path_to_mid_thresh
...
def high(image_path):
    ...
    if 'inverted' in image_path:
        path_to_high_thresh = 'resources/test2/threshold_high_inverted.jpg'
        cv2.imwrite(path_to_high_thresh, high)
        return path_to_high_thresh
    path_to_high_thresh = 'resources/test2/threshold_high.jpg'
    cv2.imwrite(path_to_high_thresh, high)
    return path_to_high_thresh
